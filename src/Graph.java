...
public class Graph {
	 ...
	 * addEdge() methods.
	 */
	public static final class Edge implements Comparable<Graph.Edge> {
		...
		/**
		 * making Edge implement Comparable makes sorting the edges 
		 * a lot easier.
		 */
		public int compareTo(Graph.Edge e) {
